...
print('VT data: {}'.format(vt.shape))
print('MT data: {}'.format(mt.shape))
# print(len(mt[mt['driver_gender'] == 'F']))

# print('male driver proportion in Montana: {}'.format(np.sum(mt.driver_gender == 'M') / mt.shape[0]))

# print(mt.stop_outcome.unique())
# print(mt.out_of_state.unique())
...
# print((mt_outState_arrested_expected, mt_inState_arrested_expected))
...
# # print(mt.violation.unique())
# # print(np.sum(mt.violation == 'Speeding'))
# # print(np.sum(mt.violation.str.contains("Speeding")))
...
# print(mta[['lon', 'lat']])
# print(mta[mta.county_fips == 30007][['lon', 'lat']])
